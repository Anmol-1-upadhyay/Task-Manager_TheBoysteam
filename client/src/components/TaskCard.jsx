...
const TaskCard = ({ task }) => {
  ...
  return (
    <>
      <div
        className="w-full h-fit bg-gray-800 text-white shadow-md p-4 rounded transition-transform transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg"
      >
        ...
        {task?.subTasks?.length > 0 ? (
          <div className="py-4 border-t border-gray-700">
            ...
            <div className="p-4 space-x-8">
              ...
              <span className="bg-blue-600/10 px-3 py-1 rounded-full text-white font-medium">
                {task?.subTasks[0].tag}
              </span>
            </div>
          </div>
